...
If you've followed this blog for any significant length of time, you already know that I'm a [big fan of virtualization](/blog/jjameson/tags/Virtualization/default.aspx). Notice that I dedicate two servers specifically to running Hyper-V virtual machines (VMs). The following figure illustrates the various servers (both logical and physical) that typically run 24x7 in my lab:
...
Also note that the "Jameson Datacenter" used to contain many more physical servers. In fact, COLOSSUS was originally a [refurbished Dell](http://www.delloutlet.com/) PowerEdge 4300 server that I shelled out 2500 bucks ($2,500) for back in July, 2000. That's when I originally came up with the naming convention, because the original COLOSSUS -- with its three power supplies and six hot-swappable hard drives -- literally weighed over 100 pounds!
