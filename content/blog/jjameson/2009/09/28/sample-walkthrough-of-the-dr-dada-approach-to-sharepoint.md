...
The next step is to build and deploy the solution. I start by pressing {{< kbd "CTRL+SHIFT+B" >}} to compile the solution and create the corresponding WSP.
