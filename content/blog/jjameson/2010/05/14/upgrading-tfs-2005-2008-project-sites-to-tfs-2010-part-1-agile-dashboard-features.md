...
Logically, my next step was to add the new TFS 2010 dashboard functionality to
...
hoping -- okay, actually _expecting_ -- to see some dashboards when I browsed to
my project site...
