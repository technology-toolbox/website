...
aliases: ["/blog/jjameson/archive/2010/09/12/avoid-extraneous-database-roundtrips-in-sharepoint-publishingpagecollection-item-property.aspx"]
draft: true
...
In [my previous post](/blog/jjameson/2010/09/02/analyzing-database-roundtrips-with-sql-server-profiler), I explained how I analyze database roundtrips using SQL Server Profiler in order to identify potential performance issues.
