...
date: 2010-04-15T04:22:00+08:00
...
In my [previous post](/blog/jjameson/archive/2010/04/09/test-driven-development-tdd-in-the-real-world-part-2.aspx), I provided a walkthrough of Test-Driven Development (TDD), based  on a very simple scenario (truncating a string to a specific number of characters).  In this post, I'll provide another example using a more complex scenario.
...
> Assert.AreNotEqual failed. Expected any value except:&lt;foobar&gt;. Actual:&lt;foobar&gt;. 
> The encrypted text (ciphertext) should not be the same as the unencrypted text 
> (plaintext).
...
> You must specify a non-autogenerated machine key to store passwords in the encrypted 
> format. Either specify a different passwordFormat, or change the machineKey 
