...
aliases: ["/blog/jjameson/archive/2010/04/08/test-driven-development-tdd-in-the-real-world-part-2.aspx", "/blog/jjameson/archive/2010/04/09/test-driven-development-tdd-in-the-real-world-part-2.aspx"]
draft: true
...
In [part 1 of this post](/blog/jjameson/2010/04/08/tdd-in-the-real-world-part-1), I provided my high-level thoughts on doing Test Driven Development (TDD) in the real world, but I didn't get around to walking through an actual sample.
...
[Note that if you are trying to conserve real estate on a Web page, there is actually [a much better way of doing this with CSS](/blog/jjameson/2009/11/01/constraining-tables-with-css), so please don't think of this scenario in that context.]
