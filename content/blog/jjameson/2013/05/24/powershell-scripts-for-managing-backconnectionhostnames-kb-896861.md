...
> **Note**
> 
> In the Fabrikam Extranet solution, the "Create Web Application.ps1" script checks if the environment is configured to use [http://extranet-local.fabrikam.com](http://extranet-local.fabrikam.com). If it is, the Add-BackConnectionHostNames.ps1 script is used to add <samp>extranet-local.fabrikam.com</samp> to the **HKLM:\System\CurrentControlSet\Control\Lsa\MSV1\_0\BackConnectionHostNames** registry key.
> 
