...
> **Important**
>
> Unlike "Clear Event Logs.vbs", Clear-EventLogs.ps1 does not save the event logs
> before clearing them. If you desire to maintain that functionality, then you'll
> need to modify the script accordingly.
>
> Personally, I haven't found the need for doing that since I only clear the event
> logs on development VMs (System Center Operations Manager "barks at you" when
> you clear the event logs on servers that are being monitored -- e.g. the
