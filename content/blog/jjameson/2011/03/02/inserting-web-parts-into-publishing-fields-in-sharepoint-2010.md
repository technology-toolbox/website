...
In the sample SharePoint solution I provided in [one of last week's posts](/blog/jjameson/archive/2011/02/25/claims-login-web-part-for-sharepoint-server-2010.aspx), you may have noticed that when programmatically creating the custom **Sign In **page, I insert the custom Claims Login Form Web Part into the **Page Content **field.
