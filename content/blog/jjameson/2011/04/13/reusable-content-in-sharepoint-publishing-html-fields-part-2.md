...
excerpt:
  ...
  Reusable Content list items (which..."
aliases:
  [
    "/blog/jjameson/archive/2011/04/13/reusable-content-in-sharepoint-publishing-html-fields-part-2.aspx",
  ]
...
some feature). [There are scenarios where you _do_ want to overwrite the
...
1. The "view format" of the content is generated by reading the "header" and
   subsequently replacing the corresponding placeholders that follow. Hence I
   tend to refer to this as the "expanded" HTML. In _most_ cases, you can get
...
1. From the Windows PowerShell command prompt, change to the directory containing the deployment scripts (e.g. C:\NotBackedUp\Fabrikam\Demo\Dev\SharePointReusableContent\Source\DeploymentFiles\Scripts), and run the following commands:
