...
Here's a useful script for those, like me, that [use SysPrep'ed images to create new virtual machines](/blog/jjameson/2009/08/12/using-sysprep-ed-vhds-for-new-hyper-v-virtual-machines) and also leverage Windows Server Update Services (WSUS) to keep machines up-to-date with the latest patches.
...
I keep a copy of this script in my [Toolbox](/blog/jjameson/2007/03/21/backedup-and-notbackedup) and run it after creating a new VM from a SysPrep'ed image.
