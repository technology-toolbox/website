...
Consequently, I decided to go with BlogEngine.NET and proceeded to create a utility to migrate my blog content from [my old MSDN blog](http://blogs.msdn.com/b/jjameson/). That's when I discovered a showstopper...
